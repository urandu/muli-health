...
class Im_Controller extends CI_Controller {
    ...
    {
        if (!is_logged_in() || !_is_receptionist() )
        {
            redirect('user/login');
        }
    }

    public function is_pharmacist()
    {
        if (!is_logged_in() || !_is_pharmacist() )
        {
            redirect('user/login');
        }
    }
    ...
    public function is_lab_attendant()
    {
        if (!is_logged_in() || !_is_lab_attendant() )
        {
            redirect('user/login');
        }
    }
