                ...
                <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <label for="patient_profile_card_no" >Tap new patient card: </label>
                            <p id="card_no"></p>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            ws.onmessage = function(evt) {
                ...
                window.location.replace('http://localhost/muli/reception/edit_patient/<?php echo($patient_id); ?>/'+message.event);
